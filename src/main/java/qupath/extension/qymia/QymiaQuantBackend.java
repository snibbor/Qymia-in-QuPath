...
import qupath.extension.qymia.QymiaUtils.RunningStatistics;
...
public class QymiaQuantBackend {
    ...
    private static final Logger logger = LoggerFactory.getLogger(QymiaQuantBackend.class);
...
//    Not for GUI
    QymiaQuantBackend(ImageData<BufferedImage> bImageData,
