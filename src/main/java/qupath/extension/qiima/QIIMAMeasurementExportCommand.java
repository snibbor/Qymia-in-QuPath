...
public class QIIMAMeasurementExportCommand implements Runnable {

	private QuPathGUI qupath;
	private final static Logger logger = LoggerFactory.getLogger(QIIMAMeasurementExportCommand.class);
	 ...
	 * @param qupath
	 */
	public QIIMAMeasurementExportCommand(final QuPathGUI qupath) {
		this.qupath = qupath;
	}
