...
public class CompAnalysisExtension implements QuPathExtension, GitHubProject {
	
	@Override
    public void installExtension(QuPathGUI qupath) {
		
		var actionStartCompMaker = ActionTools.createAction(new CompMakerPanel(qupath), "Start Compartment Maker...");
