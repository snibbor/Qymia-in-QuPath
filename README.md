...
This workflow uses the QuPath built-in SimpleThresholder as well as Qymia Quant. An example workflow guide is recorded in videos below and can be found in the powerpoint here: [Qymia Workflow](docs/Qymia-workflow-example-guide.pdf) 
